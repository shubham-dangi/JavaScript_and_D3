...
for (var q = 0; q < lines.length; q++) {
    lines[q] = lines[q].replace("Annual,","Annual");
}
...
// To change the values of production which contain NA
...
fs.writeFileSync("../json/Commercialcrop.json",JSON.stringify(result),encoding="utf8");;
